...
-- Creamos todas las tablas de manera correcta con sus INSERTs
...
-- 2. Crea una nueva tabla CitasEvaluacion que sirva para registrar la primera cita de evaluación de un trabajo 
...
-- Añadimos varios INSERTs a cada una de las tablas creadas

-- Rellenamos los datos vacíos como NULL

-- Añadimos restricciones

-- Relacionamos los clientes con los trabajos realizados
...
-- Relacionamos los trabajos con las Citas de Evaluación
ALTER TABLE CitasEvaluacion
